  ...
  return (
    <div>
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Epilogue&family=Rubik&family=Barlow&display=swap"
          rel="stylesheet"
        />
      </Head>
      ...
      <main>
        ...
        <div className="bg-banner w-full h-banner flex justify-center">
          <div className="m-auto">
            <h1 className="text-6xl w-2/3 text-center m-auto text-white mt-10 font-epilogue font-semibold">
              The Creative Industry's Premium Directory
            </h1>
            <p className="text-white w-2/5 m-auto text-center pt-3 pb-10 font-rubik">
              Where innovative companies connect with vetted marketing, creative
              and media providers for all their marketing needs.
            </p>
            <div className="text-center">
              <button className="ml-5 bg-primary text-center pt-2 pb-2 pl-8 pr-8 text-white outline-none text-sm font-barlow">
                Post a Job for Free
              </button>
              <button className="ml-5 p-2 text-white border-white border outline-none text-sm font-barlow">
