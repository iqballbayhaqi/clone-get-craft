...
export default function MainSection() {
    ...
    return (
      <a key={data.id} href={data.link} target="_blank" className="filter hover:brightness-125">
        ...
        >
          ...
          <p className="text-sm text-white w-3/4 absolute opacity-100">{`${data.title} >`}</p>
        </div>
      </a>
    );
  };
  ...
  return (
    <div className="text-center p-20 bg-secondary">
      <h1 className="text-4xl pb-5 text-white">What's inside?</h1>
      <p className="text-2xl text-white pb-20">
            ...
            {res.id % 2 === 1 ? (
              <Fragment>
                <div className="text-left col-span-2">
                  ...
                  <p className="text-white w-2/3 pt-3">
                    {res.tags.join(" / ")}
                  </p>
                  <p className="text-primary pt-5 cursor-pointer hover:underline w-max">
              ...
              <Fragment>
                ...
                <div className="w-full col-span-2 flex flex-col justify-center items-end text-right">
                  <p className="text-white text-4xl leading-tight">
                    {res.title}
                  </p>
                  <p className="text-white w-2/3 pt-3">
